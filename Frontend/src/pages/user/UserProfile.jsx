    ...
    <div>
      <div className='flex items-center justify-center flex-col p-8 gap-2'>
        ...
        <form onSubmit={handleSubmit(UpdateUserHandler)} className='flex flex-col w-1/2 border-1 p-10 rounded-xl bg-transparent '>
          ...
          <button onClick={DeleteHandler} type='button' className='text-white bg-red-500 hover:scale-[1.02] border-0 text-xl py-2 px-4 text-center rounded-xl'>Delete User <i class="ri-delete-bin-line"></i></button>
          </div>
        </form>
      </div>
    </div>
