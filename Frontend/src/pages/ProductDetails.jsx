      ...
      <div className="flex items-center justify-between gap-5 -mt-7">
        ...
        <div className="right w-[50%] p-10 text-white">
          <h1 className="text-5xl pb-5 font-thin">
            <span className="text-5xl text-red-400 font-medium">Title: </span>
            {product.title}
          </h1>
          <h1 className="text-4xl pb-5 font-thin">
            <span className="text-4xl text-red-400 font-medium">
              Description:{" "}
            </span>
            {product.description}
          </h1>
          <p className="text-4xl pb-5 font-thin">
            <span className="text-4xl text-red-400 font-medium">Price: </span>$
            {product.price}
          </p>
          <div className="flex gap-5">
            <button
              onClick={() => AddtoCartHandler(product)}
              className="text-[#1F1C2C] bg-[#918DA9] hover:scale-[1.03] text-xl py-2 px-4 text-center rounded-xl mt-2"
            >
      ...
      {users && users?.isAdmin && (
        <div className="flex items-center justify-center flex-col p-8 gap-2">
          ...
          <form
            ...
            className="flex flex-col w-1/2 border-1 p-10 rounded-xl bg-transparent"
          >
            <input
              {...register("image")}
              className="outline-0 border-b p-4 text-xl"
              type="url"
            ...
            <textarea
              ...
              className="outline-0 border-b p-4 text-xl mb-8"
              type="text"
              placeholder="Enter Description"
            />
            <button className="text-[#1F1C2C] bg-[#918DA9] hover:scale-[1.02] border-1 text-xl py-2 text-center rounded-xl pb-2">
              Update Product
            </button>
          </form>
        </div>
